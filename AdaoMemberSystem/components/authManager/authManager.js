...
Component({
    ...
    methods: {
         ...
         * 版务解释
         */
        onRead17703121: function () {
            wx.navigateTo({ url: '../thread/thread?id=17703121&is_bt=false' });
        },
        onRead25834170: function () {
            wx.navigateTo({ url: '../thread/thread?id=25834170&is_bt=false' });
        }
    }
})
